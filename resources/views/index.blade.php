...
<div class="live">
<form action="{{ route('messagesBuyer', ['id' => Session::get('loginId')]) }}" method="get">
        <button type="submit">Chat with sellers</button>
</form>
</div>
            </div>
        </div>
    ...
    <div class="button-container">
        <form action="{{ route('addToCart') }}" method="post" class="button-form">
            @csrf
        ...
        <form action="{{ route('wishlistRoute') }}" method="post" class="button-form">
            @csrf
            <input type="hidden" name="productId" value="{{ $product->id }}">
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-12">
        ...
        <div class="col-md-3 col-sm-6 col-6 p-0 float-left mb-3">
          <h5 class="mb-4 font-weight-bold text-uppercase">Our products imports</h5>
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="../sales/sales-performance-market-pipeline.html">US</a></li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="href="../project-management/project-management.html"">UK</a></li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="../workforce/workforce-organization-management-hr.html">EU</a></li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="../e-commerce/e-commerce.html"> Asia</a></li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="../finance/finance-accounting-erp.html">New zealand</a></li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="../business-apps/business-apps.html">Australia</a></li>
        </ul>
        </div>
        ...
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="https://github.com/naologic">   Exotic chips</a></li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2"><a href="https://stackshare.io/naologic">Exotic chocolate</a></li>
        </ul>
        </div>

        <div class="col-md-3 col-sm-6 col-6 mb-3 p-0 float-left">
          <h5 class="mb-4 font-weight-bold text-uppercase">Store</h5>
        <ul class="list-group">
        ...
        <ul class="list-group">
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://www.linkedin.com/company/naologic"><i class="fa fa-linkedin mr-1"></i> Instagram</a>
          </li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
          ...
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
            <a href="https://github.com/naologic" target="_blank"><i class="fa fa-github mr-1"></i> TikTok</a>  
          </li>
          <li class="list-group-item bg-transparent border-0 p-0 mb-2">
